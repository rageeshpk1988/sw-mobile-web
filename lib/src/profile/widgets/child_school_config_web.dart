...
class ChildSchoolConfigWeb extends StatefulWidget {
  final Child? child;
  final Function updateHandler;
  final Function imageHandler;
  final GlobalKey formKey;
  final bool enable;
  ChildSchoolConfigWeb(
    this.child,
    this.updateHandler,
    this.imageHandler,
    this.formKey,
  ...
  @override
  State<ChildSchoolConfigWeb> createState() => _ChildSchoolConfigWebState();
}

class _ChildSchoolConfigWebState extends State<ChildSchoolConfigWeb> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> _items = [
      ...
      DropdownSearch<String>(
        ...
        dropdownSearchDecoration: AdaptiveTheme.dropdownSearchDecoration(
            context, _selectedGender == null ? '' : 'Gender', _genderFocusNode),
      ...
      TextFormField(
        ...
        onTap: () async {
          ...
          date = (await showDatePicker(
            ...
            lastDate: _pastDOB,
            helpText: 'SELECT DATE OF BIRTH', // DateTime.now(),
      ...
      DropdownSearch<School>(
        ...
        dropdownBuilder: (context, selectedItem) {
          if (selectedItem != null)
            return Text(selectedItem.schoolName, style: _dropdownTextViewStyle);
          else
            return Text(
              'Choose your School',
        ...
        dropdownSearchDecoration: AdaptiveTheme.dropdownSearchDecoration(
            context, _selectedSchool == null ? '' : 'School', _schoolFocusNode),
        popupItemBuilder: (context, item, isSelected) {
      ...
      DropdownSearch<SchoolBoard>(
        ...
        dropdownBuilder: (context, selectedItem) {
          if (selectedItem != null)
            return Text(selectedItem.board, style: _dropdownTextViewStyle);
          else
        ...
        onFind: _selectdCountry != null &&
            ...
            : null,
        compareFn: (item, selectedValue) => item?.board == selectedValue?.board,
        dropdownSearchDecoration: AdaptiveTheme.dropdownSearchDecoration(
            context, _selectedBoard == null ? '' : 'Board', _boardFocusNode),
        popupItemBuilder: (context, item, isSelected) {
          return dropDownSearchCustomPopup(context, item.board, isSelected);
        },
        searchFieldProps: dropdownSearchCustomsearchBox(context),
      ...
      DropdownSearch<DivisionBySchoolList>(
        ...
        dropdownBuilder: (context, selectedItem) {
          if (selectedItem != null)
            return Text(selectedItem.divisionMapped,
        ...
        filterFn: (division, filter) => division!.filterByName(filter!),
        // errorBuilder: (context, searchEntry, exception) => Center(
        //     child: Text('Loading...', style: TextStyle(color: Colors.grey))),
        emptyBuilder: (context, searchEntry) => Center(
            child: Text(
      ...
      DropdownSearch<SchoolDivision>(
        ...
        dropdownBuilder: (context, selectedItem) {
          if (selectedItem != null)
            return Text(selectedItem.division, style: _dropdownTextViewStyle);
          else
            return Text(
              'Class',
              style: _dropdownLabelStyle,
        ...
        dropdownSearchDecoration: AdaptiveTheme.dropdownSearchDecoration(
            context, _selectedDivison == null ? '' : 'Class', _classFocusNode),
        popupItemBuilder: (context, item, isSelected) {
          return dropDownSearchCustomPopup(context, item.division, isSelected);
        },
        searchFieldProps: dropdownSearchCustomsearchBox(context),
      ...
      DropdownSearch<ParentReleation>(
        ...
        dropdownBuilder: (context, selectedItem) {
          if (selectedItem != null)
            return Text(selectedItem.relation, style: _dropdownTextViewStyle);
          else
            return Text(
              'Relation',
              style: _dropdownLabelStyle,
        ...
        dropdownSearchDecoration: AdaptiveTheme.dropdownSearchDecoration(
            ...
            _classFocusNode),
        popupItemBuilder: (context, item, isSelected) {
          return dropDownSearchCustomPopup(context, item.relation, isSelected);
        },
        searchFieldProps: dropdownSearchCustomsearchBox(context),
    ...
    Widget _bodyWidgetSmall() {
      return Padding(
        padding: EdgeInsets.all(screenWidth(context) >= 400 ? 50.0 : 0.0),
        child: Column(
          ...
          children: [
            ...
            //DIVISIONBYSCHOOLLIST
            if (!_divisionBySchoolList!.isEmpty) _items[7],
            //DIVISIONBYSCHOOLLIST
            if (!_divisionList!.isEmpty) verticalSpaceSmall,
            //CLASS (object name is DIVISION)
            if (!_divisionList!.isEmpty) _items[8],
            //CLASS
            if (!_divisionList!.isEmpty) verticalSpaceSmall,
            //DIVISION
            if (!_divisionList!.isEmpty) _items[9],
            //DIVISION
            verticalSpaceSmall,
            //RELATION
            _items[10],
        ...
        children: [
          Row(
            children: [
              ...
              //NAME
              SizedBox(width: 815, child: _items[0]),
              //NAME
            ],
          ),
          Row(
              ...
              Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        SizedBox(width: 400, child: _items[1]),
                      ],
                    ),
                  ),
                  //GENDER
