...
class FeedCommentsList extends StatefulWidget {
  final String feedId;
  ...
  @override
  _FeedCommentsListState createState() => _FeedCommentsListState();
}

class _FeedCommentsListState extends State<FeedCommentsList> {
  _refreshView() {
    setState(() {});
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        CommentCard(feedComment: feedComment),
                        //SizedBox(height: 10),
                        Divider(thickness: 1),
                      ],
                    );
...
class CommentCard extends StatelessWidget {
  ...
  const CommentCard({Key? key, required this.feedComment}) : super(key: key);
