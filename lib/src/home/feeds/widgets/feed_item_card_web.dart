...
import '/src/home/feeds/screens/feed_details_web.dart';
import '/src/home/feeds/widgets/feed_item_body_web.dart';
...
class FeedItemCardWeb extends StatefulWidget {
  final FeedPost feedPost;
  final bool showAddComment;
  final bool enableProfileNaviagate;
  const FeedItemCardWeb({
    Key? key,
  ...
  @override
  State<FeedItemCardWeb> createState() => _FeedItemCardWebState();
}

class _FeedItemCardWebState extends State<FeedItemCardWeb> {
        ...
        builder: (_) => Dialog(
          ...
          child: Container(
            width: screenWidth(context) *
                (screenWidth(context) > 800 ? 0.60 : 0.98),
            height: screenHeight(context) * 0.8,
            child: Center(
              child: Stack(
                children: [
                  Container(
                    //padding: EdgeInsets.fromLTRB(18.0, 20.0, 1.0, 18.0),
                    margin: EdgeInsets.only(top: 17.0, right: 15.0),
                    ...
                    child: SingleChildScrollView(
                      child: SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: FeedDetailsWeb(feedPost: widget.feedPost),
                          )),
                    ),
                  ),
                  Positioned(
                      right: 0.0,
                      top: 0.0,
                      child: Dialogs().closeButtonCircle(context)),
                ],
              ),
            ),
          ),
