...
import '../../../vendor_profile/screens/vendor_profile_web.dart';
...
import 'file_carousel_web.dart';

class FeedItemBodyWeb extends StatefulWidget {
  final FeedPost feedPost;
  final bool showAddComment;
  final bool enableProfileNaviagate;
  const FeedItemBodyWeb({
    Key? key,
  ...
  @override
  State<FeedItemBodyWeb> createState() => _FeedItemBodyWebState();
}

class _FeedItemBodyWebState extends State<FeedItemBodyWeb> {
      ...
      child: Column(
        children: [
                        ...
                        if (widget.feedPost.postedUserID ==
                          ...
                          if (widget.feedPost.postedBy == 'Vendor') {
                            Navigator.of(context).pushNamed(
                                VendorProfileScreenWeb.routeName,
          ...
          if (widget.feedPost.fileObjs!.isNotEmpty)
            FileCarouselWeb(widget.feedPost.fileObjs),
