...
class SkillEnrichmentItemWeb extends StatefulWidget {
  final ChildSkillAssessment assessment;

  SkillEnrichmentItemWeb(this.assessment);

  @override
  _SkillEnrichmentItemWebState createState() => _SkillEnrichmentItemWebState();
}

class _SkillEnrichmentItemWebState extends State<SkillEnrichmentItemWeb> {
  var _expanded = false;
            ...
            Container(
              ...
              child: GridView.builder(
                ...
                itemBuilder: (ctx, index) {
                  return EnrichmentItemWeb(
                    program: widget.assessment.programs![index],
                  );
                },
...
class EnrichmentItemWeb extends StatefulWidget {
  final ChildSkillProgram program;
  const EnrichmentItemWeb({
    Key? key,
    required this.program,
  }) : super(key: key);

  @override
  State<EnrichmentItemWeb> createState() => _EnrichmentItemWebState();
}

class _EnrichmentItemWebState extends State<EnrichmentItemWeb> {
  var _expanded = false;
...
class FeedBackWidgetWeb extends StatefulWidget {
  final List<ProductReview>? reviews;
  final int productId;
  final String productName;
  final String programType;
  final Function toggleExpansionHandler;
  const FeedBackWidgetWeb({
    Key? key,
    this.reviews,
  ...
  @override
  State<FeedBackWidgetWeb> createState() => _FeedBackWidgetWebState();
}

class _FeedBackWidgetWebState extends State<FeedBackWidgetWeb> {
