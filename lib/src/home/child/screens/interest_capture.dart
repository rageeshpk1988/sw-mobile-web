...
class InterestCaptureScreen extends StatefulWidget {
  // final Function? updateHandler;
  static String routeName = '/interest-capture';
  const InterestCaptureScreen({
    Key? key,
  }) : super(key: key);

  @override
  _InterestCaptureTempScreenState createState() =>
      _InterestCaptureTempScreenState();
}

class _InterestCaptureTempScreenState extends State<InterestCaptureScreen> {
                      ...
                      appButton(
                        ...
                        onPressed: () async {
                          ...
                          if (await ConnectivityHelper.hasInternet(
                                  context,
                                  ChildRecomendationsScreen.routeName,
                        ...
                        Row(
                          ...
                          children: [
                            appButton(
                              ...
                              width: 163,
                              height: 49,
                              titleFontSize: textScale <= 1.0 ? 14 : 10,
                              title: 'Previous',
                              titleColour:
    ...
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        ...
        shape: RoundedRectangleBorder(
            ...
            side: BorderSide(color: AdaptiveTheme.primaryColor(context))),
      ),
      onPressed: () {
        int count = 0;
        Navigator.of(context).popUntil((_) => count++ >= 2);
