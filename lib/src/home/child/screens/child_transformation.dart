...
import 'child_recomendations.dart';
import 'child_skillenrichment.dart';
import 'child_skillsummary.dart';
import 'interest_capture.dart';

class ChildTransformationScreen extends StatefulWidget {
  static String routeName = '/child-transformation';
  ChildTransformationScreen({Key? key}) : super(key: key);

  @override
  State<ChildTransformationScreen> createState() =>
      _ChildTransformationScreenState();
}

class _ChildTransformationScreenState extends State<ChildTransformationScreen> {
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        ...
                        TextSpan(
                            text:
                                "that, when recognized, serve a purpose far beyond just having fun. When analyzed earlier, this could support the child's learning and also enable them to communicate more effectively knowing their strengths.",
                            style: TextStyle(fontWeight: FontWeight.normal))
                      ],
                    ),
                  ),
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                                'This questionnaire will help you gain ',
                            style: TextStyle(fontWeight: FontWeight.normal)),
                        TextSpan(
                            text:
                                "a better understanding of your child's various interests/talents " ,
                            style: TextStyle(fontWeight: FontWeight.bold)),
                        TextSpan(
                            text:
                  ...
                  Center(
                    child: Container(
                        ...
                        child: appButton(
                          ...
                          borderColor: AdaptiveTheme.primaryColor(context),
                          onPressed: () async {
                            SharedPrefData.setBlockCounter(_child.childID!, 0);
                            Navigator.of(context).pop();
                            if (await ConnectivityHelper.hasInternet(
                                    context,
                                    InterestCaptureScreen.routeName,
    ...
    void _navigateNext(int step) async {
      ...
      switch (step) {
            ...
            if (_interestStatus!.totalCount > 0) {
              if (_interestStatus!.attendedCount == 0) {
                ...
                if (_interestStatus!.attendedCount ==
                  ...
                  screenRoute = InterestCaptureScreen.routeName;
                }
              }
            } else {
        ...
        case 2:
          if (_interestStatus != null) {
            if (_interestStatus!.submittedAny == true) {
              screenRoute = ChildRecomendationsScreen.routeName;
            } else {
        ...
        case 3:
          if (_interestStatus != null) {
            if (_interestStatus!.submittedAny == true) {
              screenRoute = ChildSkillsummaryScreen.routeName;
            } else {
              _showNavigationCheckPopup();
            }
          } else {
          ...
          if (_interestStatus != null) {
            if (_interestStatus!.submittedAny == true) {
              if (_interestStatus!.numberOfSkillsAssessed > 0) {
                screenRoute = ChildSkillEnrichmentScreen.routeName;
              } else {
        ...
        children: [
          Column(
            ...
            children: <Widget>[
              ...
              //                 size: 25, color: Color(0xFFED247C)),
              //           ),
              //           SizedBox(width: 20),
              //           Text(
              ...
              //         child: Image(
              //           image: AssetImage(
              //             'assets/images/ChildTransformationBg.png',
              //           ),
              //         ),
              //       ),
              //     ],
