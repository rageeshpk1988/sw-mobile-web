...
class ChildSkillsummaryScreenWeb extends StatefulWidget {
  static String routeName = '/web-child-skill-summary';
  ChildSkillsummaryScreenWeb({Key? key}) : super(key: key);

  @override
  _ChildSkillsummaryScreenWebState createState() =>
      _ChildSkillsummaryScreenWebState();
}

class _ChildSkillsummaryScreenWebState
    extends State<ChildSkillsummaryScreenWeb> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget _buildTitleCard(String title, String count, Color color) {
      return Container(
        width: (screenWidth(context) * 0.85) / 3,
        child: Card(
          elevation: 5.0,
          child: Center(
              child: Row(
    ...
    Widget _buildTitleCardSmall(String title, String count, Color color) {
      return Stack(
        children: [
          Container(
            width: 110,
    ...
    Widget _innerCard(
      ...
      return Stack(
        children: [
          Container(
            width: (screenWidth(context) * 0.90) * 0.24,
            height: (screenHeight(context) * 0.90) * 0.20,
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Row(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              if (category.subCategoryList![0].percentage !=
                                  0.0)
                                GestureDetector(
                                  onTap: () {
                                    if (category.subCategoryList != null) {
                                      Navigator.of(context).pushNamed(
                                          ChildSkillReportScreenWeb.routeName,
                                          arguments: category);
                                    }
                                  },
                                  child: Text(
...
//show the info message
    ...
    Widget _buildCardSmall(ChildSkillCategory category) {
      String? statusCardImageUrl;
      String? statusKidImageUrl;
      switch (category.subCategoryList![0].skill.toLowerCase()) {
        case '':
            ...
            child: SizedBox(
              ...
              child: Row(
                ...
                children: [
                  ...
                  _buildTitleCard('Developing', developingCount.toString(),
                      HexColor.fromHex('#5BC4E6')),
                  _buildTitleCard('Proficient', proficientCount.toString(),
                      ...
                      .map(
                        (category) => InkWell(
                          ...
                          child: screenWidth(context) > 800
                              ? _buildCard(category)
                              : _buildCardSmall(category),
                        ),
                      )
                      .toList(),
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    childAspectRatio: (itemWidth / itemHeight * 2.0),
                    crossAxisCount: 1,
                    crossAxisSpacing: 2.0,
                    mainAxisSpacing: 2.0,
                    mainAxisExtent: screenWidth(context) > 800 ? 250 : 180,
                  ),
                ),
              ),
            )
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: [
                      _buildTitleCardSmall('Novice', noviceCount.toString(),
                          HexColor.fromHex('#EC6E99')),
                      const SizedBox(width: 5),
                      _buildTitleCardSmall(
                          'Developing',
                      ...
                      children: _childSkillSummaryGroup!.categoryList!
                          .map(
                            (category) => InkWell(
                              ...
                              child: _buildCardSmall(category),
                            ),
                          )
                          .toList(),
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          ...
          children: [
            ...
            Container(
              width: screenWidth(context) *
                  (screenWidth(context) > 400 ? 0.94 : 0.98),
