...
class PostGeneralWeb extends StatefulWidget {
  const PostGeneralWeb({Key? key}) : super(key: key);

  @override
  _PostGeneralWebState createState() => _PostGeneralWebState();
}

class _PostGeneralWebState extends State<PostGeneralWeb> {
